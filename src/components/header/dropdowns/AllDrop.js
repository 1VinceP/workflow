...
class AllDrop extends Component {
    constructor() {
        super();
    ...
    render() {
        return(
            <div>
                ...
                >
                    <Menu>
                        <Link to='/dashboard' className='header-link'><MenuItem primaryText='Home' onClick={this.handleClose} /></Link>
                        <Link to='/analytics' className='header-link'><MenuItem primaryText='Analytics' onClick={this.handleClose} /></Link>
